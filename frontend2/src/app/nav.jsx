    ...
    <>
      <div className={`small-header ${hideSmallHeader ? 'hidden' : ''} ${darkMode ? 'dark-mode' : ''}`}>
        <div className="email-info row">
          <div className="col-md-9"><p className={`email-text ${darkMode ? 'text-light' : 'text-dark'} mx-5 my-0`}><FaRegMessage /> MedAssureConnect@gmail.com</p></div>

          <div className="scard col-md-3">
            <span>Social</span>
      ...
      <nav className={`sticky-top navbar navbar-expand-lg ${darkMode ? 'navbar-dark bg-dark' : 'navbar-light bg-light'}`}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <label className="ui-switch ml-auto">
