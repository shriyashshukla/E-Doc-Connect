        ...
        <>
            <div className="min-h-screen flex flex-col">
                <div className="flex-grow">
                    ...
                    <footer class="left-0 w-full z-50">
                        <div class="mx-auto max-w-screen-xl p-4 py-6 lg:py-8">
                            ...
                            <div class="sm:flex sm:items-center sm:justify-between">
                                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="" class="hover:underline">Shriyash Shukla</a>. All Rights Reserved.
                                </span>
